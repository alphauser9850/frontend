      ...
      <div className="relative z-20 text-center px-4">
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <h1 className={cn(
            ...
            CCNP <AuroraText>Enterprise</AuroraText>
          </h1>
        </div>
        ...
        <p className={cn(
          ...
          Our comprehensive CCNP Enterprise certification program is under development. 
          Stay tuned for an immersive learning experience that will help you master 
          advanced enterprise networking technologies.
        </p>
      </div>
    </div>
  );
