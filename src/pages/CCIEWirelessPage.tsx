...
const CCIEWirelessPage: React.FC = () => {
      ...
      <div className="relative z-20 text-center px-4">
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <h1 className={cn(
            ...
            CCIE <AuroraText>Wireless</AuroraText>
          </h1>
        </div>
        ...
        <p className={cn(
          ...
          Our comprehensive CCIE Wireless certification program is under development. 
...
export default CCIEWirelessPage; 