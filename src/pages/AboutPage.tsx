...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | CCIE Training Experts - CCIE Lab</title>
        <meta name="description" content="Learn more about CCIE Lab founded by industry experts. Our mission is to provide world-class CCIE training and help professionals achieve their career goals." />
        <meta property="og:title" content="About Us | CCIE Training Experts - CCIE Lab" />
                ...
                <BorderBeamWrapper beamColor="blue" duration={8}>
                  <div className="relative rounded-xl overflow-hidden">
                    <img
                      ...
                      alt="CCIE Lab Team Collaboration - Enterprise Infrastructure Training"
